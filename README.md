...
이 프로젝트의 목표는 C 표준 라이브러리(libc)의 일부 함수들을 재구현하고,
추가적으로 유용한 함수들을 개발하여 C 프로그래밍에 대한 이해도를 높이는 것입니다.
...
연결 리스트를 다루는 함수들입니다. [cite: 70, 71, 72]
...
2.  Makefile을 사용하여 라이브러리를 컴파일합니다.
